...
[简体中文](./EXPO_RUNTIME_QA.zh-CN.md) | [Consumer Guide](../README.md) | [API Reference](./API.md) | [Changelog](./CHANGELOG.md)
...
The supported consumer contract is the documented `expo install` command from [README.md](../README.md). A package-manager-only install of `expo-lite-data-store` is not treated as release-ready evidence because Expo peer dependencies may be missing or version-misaligned.
