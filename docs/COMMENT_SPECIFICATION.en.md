...
Each source file should include a file header comment describing the file's purpose, creation date, and last modified date.

```typescript
// src/core/example/ExampleModule.ts
// Module description, briefly explaining the module's functionality
// Created: YYYY-MM-DD
