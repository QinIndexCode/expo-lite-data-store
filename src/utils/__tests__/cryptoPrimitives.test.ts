...
describe('cryptoPrimitives', () => {
  it('pbkdf2BytesSync matches node crypto sha256 output', () => {
  ...
  it('hkdfBytesSync matches node crypto sha256 output', () => {
  ...
  it('hmacBytesSync matches node crypto sha512 output', () => {
  ...
  it('hash helpers match node crypto sha256 output', () => {
