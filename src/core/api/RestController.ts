...
export class RestController {
    ...
    async createTable(
        ...
        return this.apiWrapper.createTable(
            request.tableName,
            request.options,
            request.version
        );
    ...
    async getRecord(
        ...
        return this.apiWrapper.findOne(
            request.tableName,
            { id: request.id },
            request.version
        );
    ...
    async updateRecord(
        ...
        // 先获取现有数据
        const existingRecord = await this.apiWrapper.findOne(
            request.tableName,
            { id: request.id },
            request.version
        );
    ...
    async migrateToChunked(
        ...
        return this.apiWrapper.migrateToChunked(
            request.tableName,
            request.version
        );
    }
